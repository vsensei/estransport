...
const isInLatLngBoundsArray = (
  ...
  latLngBounds.some((latLngItem) => {
    ...
    return latLngItem.contains(newBounds);
  });
  ...
  return (
    <>
      ...
      {filteredStops.map((stop) => {
        ...
        const icon = StopIcon({
          fillColor: getColorByTransitType(stop.vehicleMode),
          isStation,
        });
